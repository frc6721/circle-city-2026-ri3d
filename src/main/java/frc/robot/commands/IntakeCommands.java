 ...
 *
 * <p>This class provides static factory methods that create commands for common intake
 * operations. Using factory methods keeps command creation logic in one place and makes
 * RobotContainer cleaner.
 *
 * <p><b>Why use factory methods instead of custom Command classes?</b>
 * <ul>
 *   <li>Simpler - no need to create separate class files for simple actions</li>
 *   <li>Less boilerplate - Commands.run() handles the command framework</li>
 *   <li>Easier to read - all intake commands in one file</li>
 *   <li>Still composable - can be combined with other commands</li>
 * </ul>
 *
...
public class IntakeCommands {
   ...
   *
   * <p>This command sets the intake's target position once and immediately finishes.
   * The PID controller in the Intake subsystem's periodic() method continues to handle
   * the actual movement to reach and maintain the position even after this command ends.
   *
   * <p><b>How it works:</b>
   * <ol>
   *   <li>Command calls intake.setIntakePosition() once</li>
   *   <li>Intake subsystem updates its target position</li>
   *   <li>Command finishes immediately</li>
   *   <li>PID controller (running in periodic()) drives motors to reach target</li>
   * </ol>
   ...
   *
   * <p>This command continuously ensures the rollers stay stopped. It's useful as
   * a default command or to explicitly stop the rollers.
   *
   * <p><b>Usage examples:</b>
   * <pre>
   ...
   * <ul>
   *   <li>Initial testing to verify motor directions</li>
   *   <li>Manual override during debugging</li>
   *   <li>Emergency control if PID fails</li>
   * </ul>
   *
   * <p>For normal operation, use setIntakeGoalPosition() instead, which provides
   * smooth, controlled movement with PID.
   *
   ...
   * IntakeConstants.INTAKE_ACQUIRE_SPEED. Use this when the intake is deployed
   * and you want to collect game pieces from the ground.
   *
   * <p><b>Typical usage:</b>
   * <pre>
   ...
   * <ol>
   *   <li>Deploy intake to PICKUP position</li>
   *   <li>Start rollers with this command</li>
   *   <li>Drive toward game piece</li>
   *   <li>Game piece is pulled into hopper</li>
   *   <li>Stop rollers</li>
   * </ol>
   *
